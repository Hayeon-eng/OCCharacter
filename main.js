const types = {
  organizer:{
    ...
    summary:"혼돈을 표와 목록으로 길들이는 사람. 한마디로, ‘일단 정리하면 살 수 있다고 믿는 인간’.",catch:"파일명 안 맞으면 집중력도 같이 무너짐.",sayings:["“일단 제가 정리해서 다시 공유드릴게요.”","“이거 담당이 누구였죠?”","“문서 위치만 맞추면 금방 됩니다.”"],
    quote:"“좋아요. 그럼 항목부터 나눠볼게요.”",
    vibe:["회식 정산도 결국 제일 먼저 끝내고 있음","회의하다가 자연스럽게 체크리스트를 만들고 있음","정리 안 된 문서를 보면 일보다 정리가 먼저 보임","누가 뭐 하는지 모르면 속으로 불안 게이지 올라감","파일명에 날짜 없으면 조용히 고통받음","결국 모두가 찾는 문서는 이 사람 폴더에 있음"],
  ...
  curator:{
    ...
    vibe:["브랜드 광고 뜨면 캡처부터 저장함","문구 하나에도 브랜드 결이 있는지 봄","색감이나 말투가 어긋나면 설명 못 해도 불편함","레퍼런스 저장하다가 원래 하던 일을 잊을 때 있음","‘조금만 더 다듬자’가 생각보다 조금이 아님","결과물이 예쁘게 맞으면 갑자기 세상 관대해짐"],
  ...
  speed:{
    ...
    summary:"멈춘 일을 앞으로 밀어내는 추진 엔진. 한마디로, ‘초안이라도 있어야 싸울 수 있다고 믿는 사람’.",catch:"일단 버전 하나 만들고 생각함.",sayings:["“일단 올려보죠.”","“초안부터 볼까요?”","“일단 방향부터 맞춰보죠.”"],
  ...
  detail:{
    ...
    quote:"“이 문구랑 asset 조합만 한번 다시 볼게요.”",
