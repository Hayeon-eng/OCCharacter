const types = {
  organizer:{
    ...
    summary:"혼돈을 표와 목록으로 길들이는 사람. 한마디로, ‘일단 정리하면 살 수 있다고 믿는 인간’.",catch:"파일명 안 맞으면 집중력도 같이 무너짐.",sayings:["“일단 방향부터 맞춰볼게요 제가 정리해볼게요.”","“이거 담당이 누구였죠?”","“문서 위치만 맞추면 금방 됩니다.”"],
    ...
    good:{type:"속도 부스터",reason:"상대가 정리해서 굴린 일을 당신이 구조화해주면, 속도와 안정감이 동시에 살아남."},
  ...
  curator:{
    ...
    good:{type:"속도 부스터",reason:"상대가 정리해서 초안을 만들고, 당신이 톤과 완성도를 입히면 빨리 나왔는데도 덜 허술해 보임."},
  ...
  speed:{
    ...
    summary:"멈춘 일을 앞으로 밀어내는 추진 엔진. 한마디로, ‘초안이라도 있어야 싸울 수 있다고 믿는 사람’.",catch:"일단 버전 하나 만들고 생각함.",sayings:["“일단 올려보죠.”","“초안부터 볼까요?”","“정리해서 가죠!”"],
    ...
    strengths:["멈춰 있는 일을 정리해서 움직이게 함","초안·샘플·테스트 버전을 빨리 만듦","논의를 실제 결과물로 전환하는 데 강함","변경 요청이 와도 정리해서 반영함","팀에 추진력을 공급함"],
    weaknesses:["검수 디테일이 약할 수 있음","정리형 동료를 불안하게 만들 수 있음","‘일단’이 많아져 후속 정리가 필요함","완성도보다 속도가 먼저 튀어나올 때가 있음"],
    hidden:["초안 생산력 98","일단 시작력 100","수정 반영 속도 90","검수창 닫기 속도 82","미래의 나 믿음 93","정리해서 가죠 빈도 95"],
    good:{type:"디테일 검수관",reason:"당신이 정리해서 판을 열고 상대가 마지막 품질을 잡아줘서, 결과물이 빨리 나오면서도 덜 위험해짐."},
  ...
  strategist:{
    ...
    good:{type:"속도 부스터",reason:"당신이 방향을 잡고 상대가 정리해서 결과물로 밀어줘서 생각이 실행으로 이어짐."},
  ...
  detail:{
    ...
    quote:"“일단 방향부터 맞춰볼게요. 여기 링크랑 문구 한 번만 더 볼게요.”",
    ...
    good:{type:"속도 부스터",reason:"상대가 초안을 정리해서 만들고 당신이 마지막 오류와 품질을 잡아줘서 효율이 좋음."},
  ...
  experimenter:{
    ...
    strengths:["새로운 방식과 개선안을 정리해서 시도함","반복 업무의 비효율을 잘 발견함","작은 테스트로 가능성을 확인함","실패를 다음 개선으로 연결함","팀에 변화의 계기를 만들어줌"],
    ...
    bad:{type:"디테일 검수관",reason:"당신은 정리해서 시도하고 싶고 상대는 안정적인 품질을 먼저 보고 싶어 해서 템포가 다름."},
  ...
  coordinator:{
    ...
    bad:{type:"속도 부스터",reason:"상대가 너무 정리해서 밀면 당신이 조율할 틈이 없어져 일정과 사람 사이에서 과부하가 올 수 있음."},
...
const questions = [
  ...
  {q:"작업물이 ‘괜찮다’고 느껴지는 기준은?",options:[
    ...
    ["🏃","정리해서 공유하고 다음 액션이 보일 때","멈춰 있는 완성도보다 움직이는 초안","speed"],
...
// added vibe refresh
console.log("OCG redesign applied");
